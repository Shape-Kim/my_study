...
hidden_size = len(char2idx) # RNN output size. This is not final output
num_classes = len(char2idx) # RNN final output size.
batch_size = 1 # we only have one example
sequence_length = len(sample) - 1
learning_rate = 0.1

sample_idx = [char2idx[c] for c in sample]
x_data = [sample_idx[:-1]] # This is " if you want yo"
y_data = [sample_idx[1:]] # This is "if you want you"
